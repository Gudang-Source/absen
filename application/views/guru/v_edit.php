            ...
            <div class="card-body">
              <div class="row">
	              ...
	              <form action="<?php echo base_url('guru/update') ?>" method="post" accept-charset="utf-8">
	                  ...
	                  <input type="radio" name="i_status" value="Mutasi" <?php if($detail->status=='Tidak Aktif'){echo 'checked';} ?> id="takaktif"><label for="takaktif">&nbsp;Tidak Aktif</label>
	                </div>
	                <div class="form-group">
	                  <b>NIP</b>
	            ...
	            <div class="col-md-6">
	                ...
	                <div class="form-group">
	                  <b>Password</b>
	                  <input type="password" name="i_pwd" value="<?php echo $detail->pwd ?>" class="form-control">
	                </div>
	                <div class="form-group">
	                  <b>Level User</b>
