...
<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="alert alert-info alert-dismissible fade show" role="alert">
            1. Download Format File Excel <strong><a href="<?php echo base_url('/excel/FormatUploadDataSiswa.xlsx') ?>" title="">Disini.</a></strong><br>
          ...
          <div class="card shadow mb-4 border-bottom-primary">
            ...
            <div class="card-body">
              <form action="<?php echo base_url('siswa/upload') ?>" method="post" enctype="multipart/form-data">
              ...
              <?php
                if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
                  ...
                  foreach($sheet as $row){ 
                    ...
                    $tpt_lahir = $row['E'];
                    $tgl_lahir = $row['F'];
                    $alamat = $row['G']; // Ambil data alamat
                    
                    // Cek jika semua data tidak diisi
                    if($nis == "" && $nisn == "" && $nama == "" && $jenis_kelamin == "" && $tpt_lahir == "" && $tgl_lahir == "" && $alamat == "")
                    ...
                    if($numrow > 1){
                      ...
                      $nisn_td = ( ! empty($nisn))? "" : " style='background: #E07171;'"; // Jika NISN kosong, beri warna merah
                      ...
                      if($nis == "" or $nisn == "" or $nama == "" or $jenis_kelamin == "" or $tpt_lahir == "" or $tgl_lahir == "" or $alamat == ""){
