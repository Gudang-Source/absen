...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2020 at 04:04 AM
...
INSERT INTO `tb_absensi` (`id_absen`, `tgl_absen`, `kd_kelas`, `kd_mapel`, `kd_siswa`, `kehadiran`, `smt`) VALUES
(1, '2020-01-19', 7, 1, 124, 'H', 2),
(2, '2020-01-19', 7, 1, 20180014, 'H', 2);
...
(1, 'Kinan', 'L', 'Jakarta', 'Jakarta', '1987-05-12', 'Aktif', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin'),
(2, 'Jinan', 'P', 'Kebonwaru', 'Jakarta', '1987-09-19', 'Aktif', 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'User');
